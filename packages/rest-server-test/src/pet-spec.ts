import { num, str, strictObjOf, arrOf, undef, Contract } from 'parmenides';
import { createServerSomething, RouteDefinition } from './server';
...
export default createServerSomething<PetsEndpoints, AllEndpoints>({
    get: {
        '/pets': {
